...
const products = [
  ...
  },
  {
    ...
    subcategory: 'Yoga',
    images: ['https://images.unsplash.com/photo-1601925228240-168a88ef2cf2?w=600'],
    brand: 'ZenFlow',
    stock: 65,
    sku: 'ZF-YMP-005',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1593640408182-31c228c6641a?w=600'],
    brand: 'ChargeFast',
    stock: 90,
    sku: 'CF-WCP-008',
...
async function seed() {
  ...
  console.log('✅ Created test user: test@shop.com / test1234');
